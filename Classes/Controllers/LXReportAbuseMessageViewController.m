...
@interface LXReportAbuseMessageViewController ()

@end

@implementation LXReportAbuseMessageViewController
...
- (void)viewDidLoad
{
    ...
    textOriginal.text = _message[@"body"];
}
...
- (IBAction)touchReport:(id)sender {
    NSString *path = [NSString stringWithFormat:@"user/report_abuse/%@/%ld", @"message", [_message[@"id"] longValue]];
