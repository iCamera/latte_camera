...
- (NSString*)getNewBlend:(UIButton *)sender {
    ...
    switch (sender.tag) {
        ...
        case 2:
            blendid = 1 + rand() % 20;
            blend = [NSString stringWithFormat:@"flower-%d.jpeg", blendid];
            break;
        case 3:
            blendid = 1 + rand() % 20;
            blend = [NSString stringWithFormat:@"star-%d.jpeg", blendid];
            break;
        case 4:
            blendid = 1 + rand() % 22;
            blend = [NSString stringWithFormat:@"heart-%d.jpeg", blendid];
            break;
        case 5:
            blendid = 1 + rand() % 25;
            blend = [NSString stringWithFormat:@"lightblur-%d.jpeg", blendid];
            break;
        case 6:
            blendid = 1 + rand() % 25;
