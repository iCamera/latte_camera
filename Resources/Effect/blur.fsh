...
mediump float ndofdist = 2.0; //near dof blur falloff distance
mediump float fdofstart = 1.0; //far dof blur start
mediump float fdofdist = 3.0; //far dof blur falloff distance
...
mediump float feather = 0.4; //pentagon shape feather
